...
export function Project({ orientation = 'left' }: ProjectProps) {
  return (
    <article className="container mx-auto grid grid-cols-2 gap-32 pb-20">
      {orientation === 'right' && (
        <div className="">
      ...
      <div className={`text-${orientation}`}>
        ...
        <p className="leading-7 mb-12">
          ...
          molestie luctus. Morbi vel cursus ex, nec sodales odio. Integer tempor
          est vel lorem finibus, nec ullamcorper diam ornare. Vestibulum ante
